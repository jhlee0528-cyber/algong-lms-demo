...
const customTextPlugin = {
  ...
  afterDraw(chart) {
    ...
    ctx.fillText("분", chartArea.left - 21, chartArea.bottom + 18.5); // "점" 추가
    ctx.restore();
  },
};
    ...
    createChart() {
      ...
      const data = {
        ...
        datasets: [
          {
            label: "액티비티",
            data: this.chartData.activityTimes, // 액티비티 데이터
          ...
          {
            label: "AI 대화",
            data: this.chartData.talkingTimes, // AI 대화 데이터
          ...
          tooltip: {
            callbacks: {
              label: function (tooltipItem) {
                return `${tooltipItem.dataset.label}: ${tooltipItem.raw}분`;
              },
            },
          },
          legend: {
